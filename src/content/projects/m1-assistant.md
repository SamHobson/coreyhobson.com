...
<svg width="160" height="170" viewBox="0 0 160 170" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="28" y="60" font-family="SF Mono, monospace" font-size="10" fill="#C2703E"># Meeting</text>
  <text x="28" y="76" font-family="SF Mono, monospace" font-size="10" fill="#8B8580">Discussed the</text>
  <text x="28" y="90" font-family="SF Mono, monospace" font-size="10" fill="#8B8580">new ingest</text>
  <text x="28" y="104" font-family="SF Mono, monospace" font-size="10" fill="#8B8580">pipeline.</text>
  <text x="28" y="124" font-family="SF Mono, monospace" font-size="10" fill="#C2703E">## Decisions</text>
  <text x="28" y="140" font-family="SF Mono, monospace" font-size="10" fill="#8B8580">- ship behind flag</text>
  <text x="80" y="164" font-family="-apple-system, sans-serif" font-size="10" fill="#8B8580" text-anchor="middle">notes.md</text>
</svg>
</div>
</div>

<div class="flex flex-col md:flex-row-reverse gap-8 my-10 items-center">
<div class="flex-1">
...
<svg width="180" height="130" viewBox="0 0 180 130" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="16" y="50" font-family="SF Mono, monospace" font-size="10" fill="#34d399">&gt; summarize arno</text>
  <text x="16" y="66" font-family="SF Mono, monospace" font-size="10" fill="#34d399">  meeting from</text>
  <text x="16" y="82" font-family="SF Mono, monospace" font-size="10" fill="#34d399">  tuesday</text>
  <text x="16" y="104" font-family="SF Mono, monospace" font-size="10" fill="#E6E4E0">Arno raised concerns</text>
  <text x="16" y="116" font-family="SF Mono, monospace" font-size="10" fill="#E6E4E0">about throughput...</text>
</svg>
</div>
</div>
...
<svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="15" y="146" font-family="-apple-system, sans-serif" font-size="10" fill="#8B8580" text-anchor="middle">Mon</text>
  <text x="95" y="146" font-family="-apple-system, sans-serif" font-size="10" fill="#8B8580" text-anchor="middle">Wed</text>
  <text x="175" y="146" font-family="-apple-system, sans-serif" font-size="10" fill="#8B8580" text-anchor="middle">Fri</text>
  <text x="95" y="50" font-family="-apple-system, sans-serif" font-size="10" fill="#8B8580" text-anchor="middle" font-style="italic">memory carries across</text>
  ...
  <text x="41" y="196" font-family="-apple-system, sans-serif" font-size="7" fill="#8B8580" text-anchor="middle">Work</text>
  <text x="144" y="196" font-family="-apple-system, sans-serif" font-size="7" fill="#8B8580" text-anchor="middle">Personal</text>
</svg>
</div>
</div>
